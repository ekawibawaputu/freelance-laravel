...
class ServiceController extends Controller
{
    ...
    public function store(StoreServiceRequest $request)
    {
        ...
        toast()->success('Save has been saved successfully');
    ...
    public function edit(Service $service)
    {
        ...
        return view('pages.dashboard.service.edit', compact('service', 'tagline', 'advantage_service', 'thumbnail_service', 'advantage_user'));
    }
