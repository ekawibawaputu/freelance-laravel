                                        ...
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                ...
                                                @if ($order->user_buyer->detail_user->photo != null)
                                                    <img class="object-cover w-full h-full rounded-full" src="{{ url(Storage::url($order->user_buyer->detail_user->photo)) }}" alt="photo freelance" loading="lazy" />
                                                @else
                            ...
                            <div class="flex p-8 border border-gray-200 rounded-lg bg-serv-upload-bg h-128">
                                ...
                                <div class="">
                                    ...
                                    <div class="px-1 py-4 text-right">
                                        <a  href="{{ route('member.order.index') }}" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" onclick="return confirm('Are you sure want to cancel this ?, Any changes won`t be saved.')">
                                            Back
                                        </a>
